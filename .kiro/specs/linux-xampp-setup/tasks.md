...
- [ ] 1. XAMPP muhitini tekshirish va sozlash
...
- [ ] 1.1 XAMPP xizmatlarini ishga tushirish
...
- [ ] 1.2 PHP versiyasi va extensionlarni tekshirish
...
- [ ] 1.3 PHP konfiguratsiyasini sozlash
...
- [ ] 2. Loyihani XAMPP htdocs papkasiga ko'chirish
...
- [ ] 2.1 Loyihani ko'chirish yoki symlink yaratish
...
- [ ] 3. MySQL database yaratish va import qilish
...
- [ ] 3.2 SQL dump faylini import qilish
...
- [ ] 4.1 Virtual host konfiguratsiyasini yaratish
...
- [ ] 4.2 httpd.conf'da virtual hosts'ni yoqish
...
- [ ] 4.3 /etc/hosts faylini tahrirlash
...
- [ ] 4.4 Apache konfiguratsiyasini test qilish va qayta ishga tushirish
...
- [ ] 5. Laravel environment (.env) faylini yaratish va sozlash
...
- [ ] 5.2 .env faylida database sozlamalarini o'zgartirish
...
- [ ] 5.3 .env faylida AI va boshqa sozlamalarni tekshirish
...
- [ ] 5.4 APP_KEY generatsiya qilish
...
- [ ] 6.1 Composer mavjudligini tekshirish
...
- [ ] 8. Laravel cache va konfiguratsiyalarni sozlash
  - Config cache yaratish
  - Route cache yaratish (optional)
  - View cache tozalash
  - _Requirements: 5.4, 5.5_

- [ ] 8.1 Laravel cache buyruqlarini bajarish
...
- [ ] 9. Ilovani test qilish va troubleshooting
...
- [ ] 9.1 Brauzerda ilovani ochish va asosiy test
...
- [ ] 9.2 Database ulanishini test qilish
...
- [ ] 9.3 Static assets (CSS, JS, images) yuklanishini tekshirish
...
- [ ] 9.4 AI funksiyalarini test qilish (optional)
...
- [ ] 9.5 Log fayllar va permissions'ni yakuniy tekshirish
